...
@Component
public class EventStoreGroupListenerA {

    private static final Logger log = LoggerFactory.getLogger(EventStoreGroupListenerA.class);
    ...
    public void onEvent(EventStoreMessageReceived event) {
        ...
        log.info("[Store-Listener-A] Received: sequence={} body={}", event.getSequence(), body);
    }
}
